 ...
 */
 ...
 exports.create = function (req, res) {
  ...
  pubDoc.meta._owner = req.user._id;
...
exports.list = function  (req, res) {
  PubDoc
    ...
    .sort('score')
    .limit(20)
    .select('body title score up_votes hearts')
...
//   var id = req.body._id;
//   var newpubDoc = req.body.data;

//   pubDoc.findById(id, function(err, pubDoc) {
//     if (err) console.log(err);

//     pubDoc.data = newpubDoc;

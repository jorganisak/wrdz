...
PubDocSchema.statics = {
  load : function (id, cb) {
    this.findOne({_id: id}, 'published_at author is_anon views score up_votes reposts meta hearts doc')
      .populate('doc', 'title body has_title topics', null, {populate:['topics']})
